...
const retailers: Retailer[] = [
  ...
  { name: "eBay Outdoors", url: "https://www.ebay.com", searchUrl: "https://www.ebay.com/sch/i.html?_nkw={q}", categories: ["Camping", "Hiking", "Fishing", "Hunting", "Knives & Blades", "Cycling", "Water Sports"], status: "active", network: "eBay Partner Network", commission: "1-4%", cookie: "24 hours" },
